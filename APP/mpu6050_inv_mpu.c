 ...
 *  @param[in]  int_param   Platform-specific parameters (unused).
...
/**
 *  @brief      Read from the FIFO stream.
...
/**
 *  @brief      Trigger gyro/accel self-test.
 *  @param[out] gyro        Gyro biases in q16 format.
 *  @param[out] accel       Accel biases in q16 format.
 *  @return     Result mask (bit 0: gyro pass, bit 1: accel pass).
 */
